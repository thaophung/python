...
from pylab import *
import sys
caffe_root = '/Users/thaophung/caffe/' # this file should be run from {caffe_root}/
...
i#PRETRAINED = '/Users/thaophung/caffe/examples/mnist/lenet_original_caffemodel/lenet_original_iter_10000.caffemodel'
